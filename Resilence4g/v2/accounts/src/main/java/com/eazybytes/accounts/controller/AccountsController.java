...
public class AccountsController {
    ...
    @Operation(
            summary = "Accounts Build Information",
            description = "REST API to get the cuurent build version information using this endpoint."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @RateLimiter(name = "getEnvironmentInfo")
