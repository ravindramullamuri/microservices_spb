...
class ApiEndpoints {
  ...
  static String emailVerificationSendOTP =
      '$baseUrl/api/email-verification/send-otp';
  // Verify the OTP
  static String emailVerificationVerifyOtp =
  ...
  static String createPatientWeightAndHeight =
      '$baseUrl/api/patient-weight-height-logs/create';

  /// Risk Meter
  static String riskMetricDashboard(String userId, String timezone) =>
      '$baseUrl/api/patient-heart-risk-metrics/riskMetricDashboard?patientId=$userId&timeZone=$timezone';
  static String riskMetricHeroSection =
      '$baseUrl/api/patient-heart-risk-metrics/riskMetricDashboard';
  //static String heartRiskSummary='$baseUrl/api/patient-heart-risk-metric-histories/heart-risk-summary';
  static String heartRiskSummary =
      '$baseUrl/api/patient-heart-risk-metrics/heart-risk-summary';

  /// Sodium

  static String patientMealLogsNutrientSummary =
      '$baseUrl/api/patient-meal-logs/nutrient-summary';
  static String patientMealLogsNutrientSummaryByMealType =
      '$baseUrl/api/patient-meal-logs/nutrient-summary-by-meal-type';
  ...
  static String getMealTypesURL =
      '$baseUrl/api/app-param-values/get-meal-types';
  ...
  static String foodItemsWithNutrients =
      '$baseUrl/api/food-items/with-nutrients';
  static String userPatientMealLogs(int mealLogId) =>
      '$baseUrl/api/patient-meal-logs/$mealLogId';
  static String userPatientMealMenuLogs(int mealLogId) =>
      '$baseUrl/api/patient-meal-menus/$mealLogId';
  static String createMeal = '$baseUrl/api/patient-meal-logs/create-meal';
  static String editMeal(int mealId) =>
      '$baseUrl/api/patient-meal-logs/edit-meal/$mealId';
  ...
  static String patientMealMenusWithNutrients =
      '$baseUrl/api/patient-meal-menus/with-nutrients';
  ...
  static String trackInTakeMedications =
      '$baseUrl/api/medications/track-intake';
  // medicationsScheduleList
  static String medicationsScheduleList =
      '$baseUrl/api/medications/schedule-list';
  // My Medication
  static String myMedicationsList = '$baseUrl/api/medications/my-medications';
  // intakeStatsOfMedications
  static String intakeStatsOfMedications =
      '$baseUrl/api/medications/intake-stats';
  // editScheduleMedications
  static String editScheduleMedications =
      '$baseUrl/api/medications/edit-schedule';
  //
  ...
  // removeMyMedication
  static String removeMyMedication =
      '$baseUrl/api/medications/remove-my-medication';
  // delete
  ...
  static String intakeMedicationCountSummary =
      '$baseUrl/api/medications/intake-count-summary';
  // medicationScheduleOverviewInfo
  static String medicationScheduleOverviewInfo =
      '$baseUrl/api/medications/schedule-overview';
  static String medicationsDailyIntakeStats =
      '$baseUrl/api/medications/daily-intake-stats';
  static String medicationsIntakeStats =
      '$baseUrl/api/medications/intake-stats';
  static String medicationsAdd = '$baseUrl/api/medications/add';
  static String medicationMenuByUUID(menuUuid) =>
      '$baseUrl/api/medications/menu/$menuUuid';
  ...
  static String patientWeightHeightLogsRange =
      '$baseUrl/api/patient-weight-height-logs/range';
  static String bmiStatus(int id) => '$baseUrl/api/bmi-statuses/$id';
  static String patientWeightHeightLogs =
      '$baseUrl/api/patient-weight-height-logs';
  static String heroDashboardOfBMI =
      '$baseUrl/api/patient-weight-height-logs/heroDashboard';
  static String createPatientWeightHeight =
      '$baseUrl/api/patient-weight-height-logs/create';
  static String updatePatientWeightHeight(WeightHeightLog log) =>
      '$baseUrl/api/patient-weight-height-logs/${log.id}';
  static String userCurrentAndPastDataOfBMI =
      '$baseUrl/api/patient-weight-height-logs/currentAndPastData';
  ...
  static String get notificationMarkSeen =>
      "$baseUrl/api/notifications/mark-seen";
  ...
  // Notifications
  static String notificationsDataURL({int page = 0, int size = 20}) =>
      '$baseUrl/api/notifications?page=$page&size=$size';
  // Add Symptoms
  static String createPatientSymptoms =
      '$baseUrl/api/patient-symptom-tracks/create-new';
}
