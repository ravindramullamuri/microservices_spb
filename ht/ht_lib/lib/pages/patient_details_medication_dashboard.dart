...
class PatientDetailsMedicationDashboard extends StatelessWidget {
  final String patientName;
  final String patientAge;
  final String patientGender;
  final String patientImage;

  const PatientDetailsMedicationDashboard({
    Key? key,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _buildDailyMedicationBreakdown(),
  ...
  Widget _buildDailyMedicationBreakdown() {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildMedicationCircle('4/4', Colors.green),
              _buildMedicationCircle('4/3', Colors.orange),
              _buildMedicationCircle('3/6', Colors.red),
            ],
          ),
        ],
      ),
  ...
  Widget _buildMedicationCircle(String fraction, Color color) {
    return Container(
      width: 80,
      height: 80,
      decoration: BoxDecoration(
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildBar(40, Colors.yellow, '18'),
                _buildBar(100, Colors.orange, '19'),
                _buildBar(120, Colors.orange, '20'),
